...
namespace MPSTI.PlenoSoft.Camunda.Proxies
{
	public class ProxyCamunda : IProxyCamunda
	{
		private readonly HttpClient _httpClient;
		private readonly ExternalTaskFetchRequest _fetchExternalTaskRequest;

		public ProxyCamunda(IHttpClientFactory httpClientFactory, ExternalTaskConfig externalTaskConfig)
		{
