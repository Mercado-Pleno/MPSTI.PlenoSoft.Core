...
namespace MPSTI.PlenoSoft.Camunda.Services.ServiceBus
{
	...
	{
		public static readonly QueueDescription QueueTemplate = new QueueDescription("QueueName")
		{
		...
		public static readonly TopicDescription TopicTemplate = new TopicDescription("TopicName")
		{
