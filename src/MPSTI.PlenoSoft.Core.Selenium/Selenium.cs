...
namespace MPSTI.PlenoSoft.Core.Selenium
{
	public class SeleniumRWD
	{
		...
		public IWebElement Set(string idOrName, bool click)
		{
		...
		public bool ContainsAllText(bool caseSensitive, params string[] texts)
		{
			return RemoteWebDriver.GetBody().ContainsAllText(caseSensitive, texts);
		}

		public bool ContainsAnyText(bool caseSensitive, params string[] texts)
		{
			return RemoteWebDriver.GetBody().ContainsAnyText(caseSensitive, texts);
		}

		public bool WaitUntilContainsAllText(IWebElement webElement, CancellationToken cancellationToken, bool caseSensitive, params string[] texts)
		{
		...
		public bool WaitWhileContainsAllText(IWebElement webElement, CancellationToken cancellationToken, bool caseSensitive, params string[] texts)
		{
			while (!cancellationToken.IsCancellationRequested && webElement.ContainsAllText(caseSensitive, texts))
				Thread.Sleep(WaitLoopSleep);
		...
		public bool ContainsAllText(IWebElement webElement, bool caseSensitive, params string[] texts)
		{
		...
		public bool ContainsAnyText(IWebElement webElement, bool caseSensitive, params string[] texts)
		{
			var webElementText = caseSensitive ? webElement.Text : webElement.Text.ToUpper();
			return texts.Length == 0 || texts.Select(t => caseSensitive ? t : t.ToUpper()).Any(t => webElementText.Contains(t));
		}

		public bool EstaPreenchido(string idOrName, string value)
		{
		...
		public IWebElement Enter(IWebElement webElement, int dalayOfEnter)
		{
		...
		public IWebElement GetElement(ISearchContext searchContext, string tagName, int skip = 0)
		{
