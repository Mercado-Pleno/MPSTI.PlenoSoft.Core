    ...
    public class FamiliaController
    {
        ...
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get")] HttpRequest req,ILogger log)
        {
            try
            {
			    ...
			    await _familiaRepository.UpdateItem(new Familia { Id = Guid.Parse("fa872c5a-665d-4f71-bff4-56f26fa31fb0"), FirstName = "Luani", LastName = "Fernandes", Doc = "123" });
			    await _familiaRepository.UpdateItem(new Familia { Id = Guid.Parse("6fdf1933-7628-40de-aa04-c7a546606c4c"), FirstName = "Bruno", LastName = "Fernandes", Doc = "456" });
			    await _familiaRepository.UpdateItem(new Familia { Id = Guid.Parse("849325fc-5656-4aad-983b-d5802ecd4d14"), FirstName = "Filho", LastName = "Fernandes", Doc = "789" });

			    await _familiaRepository.UpdateItem(new Familia { Id = Guid.Parse("1f00b4bf-0000-0400-0000-63799e3e0000"), FirstName = "Rita", LastName = "Nogueira", Doc = "000" });
